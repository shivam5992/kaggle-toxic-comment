...
def Tfidfize(df, name):
	...
	sparse.save_npz('train_idfidf.npz', tfidf)
	with open('tfidf_model.pk', 'wb') as fin:
...
if predicting == 1:
	...
	model_toxic_comb = pickle.load(open("data/convai/model1_toxic_comb4.pk", "rb"))
	model_attack_comb = pickle.load(open("data/convai/model1_attack_comb4.pk", "rb"))
	model_aggression_comb = pickle.load(open("data/convai/model1_aggression_comb4.pk", "rb"))

	tfidfer_toxic = pickle.load(open("data/convai/tfidfer_toxic.pk", "rb"))
	tfidfer_attack = pickle.load(open("data/convai/tfidfer_attack.pk", "rb"))
	tfidfer_aggression = pickle.load(open("data/convai/tfidfer_aggression.pk", "rb"))

	tfidfer_toxic_char = pickle.load(open("data/convai/tfidfer_toxic_char.pk", "rb"))
	tfidfer_attack_char = pickle.load(open("data/convai/tfidfer_attack_char.pk", "rb"))
	tfidfer_aggression_char = pickle.load(open("data/convai/tfidfer_aggression_char.pk", "rb"))

	tfidfer_toxic_char4 = pickle.load(open("data/convai/tfidfer_toxic_char_cln4.pk", "rb"))
	tfidfer_attack_char4 = pickle.load(open("data/convai/tfidfer_attack_char_cln4.pk", "rb"))
	tfidfer_aggression_char4 = pickle.load(open("data/convai/tfidfer_aggression_char_cln4.pk", "rb"))
	...
	train_orig.to_csv('data/train_convai_wordchars4.csv', index=False)
	test_orig.to_csv('data/test_convai_wordchars4.csv', index=False)